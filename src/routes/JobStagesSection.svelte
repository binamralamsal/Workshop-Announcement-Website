  ...
  <div class="container">
    ...
    <div class="stages">
      <div class="stage stage-first">
        <div class="icon" data-aos="fade-up" data-aos-delay="150">
          <svg
            width="30"
            height="30"
            viewBox="0 0 45 39"
        ...
        <p class="stage-description" data-aos="fade-up" data-aos-delay="300">
      ...
      <div class="stage stage-second">
        ...
        <p class="stage-description" data-aos="fade-up" data-aos-delay="300">
          We offer lectures, weekly presentations, soft skill training, and mock
          interviews to help students perform well in these stages.
        </p>
      </div>
      <div class="stage stage-third">
        <div class="icon" data-aos="fade-up" data-aos-delay="150">
          <svg
            width="30"
            height="30"
